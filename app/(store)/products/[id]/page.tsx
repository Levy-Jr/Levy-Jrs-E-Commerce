    ...
    <div className="p-6">
      <div className="flex justify-between gap-4">
        ...
        <div className="flex-2 p-6 shadow-xl w-full max-w-[45%] pt-20 mx-auto">
          ...
          <Button className="bg-[#FF0000] hover:bg-red-600 font-semibold tracking-widest text-xl w-full py-6" asChild>
            <Link href={`/products/${params.id}/purchase`}>COMPRAR</Link>
          </Button>
        </div>
      </div>
      <div className="mt-12">
